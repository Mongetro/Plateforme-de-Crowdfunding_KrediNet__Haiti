			...
			function b(b){
				...
				String.prototype.includes||!function(){
					...
					String.prototype.startsWith||!function(){
						...
						b={}.toString,
						c=function(a){
							if(null==this)throw new TypeError;var c=String(this);
						...
						a.valHooks.select.set=function(b,c){
							...
							var e=null,f=function(){
								try{return new Event("change"),!0}
								catch(a){return!1}}();
								a.fn.triggerNative=function(a){
									var b,
									c=this[0];
									c.dispatchEvent?(f?b=new Event(a,{bubbles:!0}):(b=document.createEvent("Event"),b.initEvent(a,!0,!1)),
									c.dispatchEvent(b)):c.fireEvent?(b=document.createEventObject(),b.eventType=a,c.fireEvent("on"+a,b)):this.trigger(a)
								},
